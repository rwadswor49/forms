...
export default function SourceOfWealth({ goHome, formTitle, printMode, setPrintMode }) {
  ...
  return (
    <div className="app">
      ...
      {/* ⭐ FIX: HEADER OUTSIDE SCROLL AREA */}
      {!printMode && (
        <FormHeader
      ...
      <div className="page-container">
        ...
        <div className="main-layout">
          <div className="form-area">
            ...
            {currentPage === 2 && (
              <EmploymentForm ref={form2Ref} data={page2Data} setData={setPage2Data} />
            )}
          ...
          <div className="side-panel">
            <div className="notes-panel">
              ...
              {currentPage === 1 ? (
                <ul>
                  <li>
                    The Isle of Man Financial Services Authority requires all Isle of Man life companies to make enquiries as to how an applicant has acquired the monies to be used as payment for their plan.
                  </li>
                  <li>
                    RL360 take a risk-based approach to comply with this legislation by risk rating each customer.
                  </li>
                  <li>
                    Where a higher risk is identified, we must establish the customer’s source of wealth.
                  </li>
                  <li>
                    Full details can be obtained from your financial adviser.
                  </li>
                </ul>
              ) : (
                <ul>
