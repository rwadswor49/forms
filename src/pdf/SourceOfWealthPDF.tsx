...
const Header = () => (
  <View style={{ marginBottom: 20 }}>
    ...
    {/* Paragraph starts 3 lines below title */}
    <Text style={{ fontSize: 10, marginTop: 4, lineHeight: 1.4 }}>
...
const SectionEmployment = ({ data }) => (
  <View style={styles.section}>
    ...
    <View style={styles.fieldGroup}>
      ...
      <Text style={styles.value}>
        {[data?.addressLine1, data?.townOrCity, data?.stateOrProvince, data?.postalCode, data?.country]
          .filter(Boolean)
          .join(", ")}
      </Text>
    </View>
...
/* ------------------------------
   DECLARATION + SIGNATURE LAST PAGE
------------------------------ */
const DeclarationPage = () => (
  <Page size="A4" style={styles.page}>
    <Text style={styles.sectionTitle}>DECLARATION</Text>
    <Text style={styles.declarationText}>
      I declare that the above answers are true to the best of my knowledge and that I have not withheld any information.
    </Text>

    <Text style={styles.sectionTitle}>PRIVACY POLICY</Text>
    <Text style={styles.declarationText}>
      Our full privacy policy can be viewed at www.rl360.com/privacy or can be obtained by requesting a copy from our Data Protection Officer.
    </Text>
    ...
    <Text style={styles.footer}>
      RL360 Insurance Company Limited. Registered Office: International House, Cooil Road, Douglas, Isle of Man, IM2 2SP, British Isles. Registered in the Isle of Man number 137548C. RL360 Insurance Company Limited is authorised by the Isle of Man Financial Services Authority.
    </Text>
  </Page>
);
...
export default function SourceOfWealthPDF({ data }) {
  return (
    <Document>
      ...
      {/* Last Page: Declaration + Privacy + Signature */}
      <DeclarationPage />
    </Document>
  );
}