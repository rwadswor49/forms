...
const SectionCompanyDetails = ({ data }) => (
  <Section title="Company Details">
    <EntryBox title="Company">
      <Entry label="Company Name" value={data.companyName} />
      <Entry label="Registered Address" value={data.registeredAddress} />
      <Entry label="Date Moved to This Address" value={data.dateMoved} />
      <Entry label="Correspondence Address" value={data.correspondenceAddress} />
      <Entry label="Country of Tax Residence" value={data.taxResidence} />
      <Entry label="Tax Reference" value={data.taxReference} />
      <Entry label="No Tax Reference Reason" value={data.noTaxRefReason} />
      <Entry label="FATCA GIIN" value={data.fatcaGiin} />
    </EntryBox>
  </Section>
);
